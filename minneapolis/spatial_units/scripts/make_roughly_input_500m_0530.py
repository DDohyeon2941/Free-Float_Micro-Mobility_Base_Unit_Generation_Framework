...
#%%
    ...
    pd.DataFrame(data=[xx.wkt for xx in grid_poly_list]).to_csv(r'minneapolis_filtered_grid.csv')
    ...
    uu.save_gpickle('minneapolis_grid_elements_0530.pickle', {'grid_list':grid_poly_list,  'alpha':alpha, 'beta':beta})


    new_temp_df.to_pickle(r'minneapolis_roughly_filtered_dataset_0530.pkl')
