...
from minneapolis_new_main_indi_grids_fixed_train_vali_123_250m_0812 import SharingBikes, LSTM1, train, validate
...
temp_pkl1 = uu.load_gpickle(r'%s_fixed_train_test_scaler_dataset_250m_%s.pickle'%(city_name, save_date1))
scaler, new_train_df, test_df = temp_pkl1['scaler'],  temp_pkl1['train_dataset'],  temp_pkl1['test_dataset']

#hyper_params_dic = uu.load_gpickle(r'%s_sub12345_fixed_vali_hyper_params.pickle'%(city_name))[subset_name]
...
if __name__ == '__main__':
    ...
    for uni_try in range(try_num):
        ...
        uu.save_gpickle(r'minneapolis_fixed_model_loss_test_250m_%s_%s.pickle'%(uni_try, save_date), aa2)
        ...
        uu.save_gpickle(r'minneapolis_real_pred_y_fixed_250m_%s_%s.pickle'%(uni_try, save_date),
        ...
        o_score_df.to_csv(r'minneapolis_o_score_df_fixed_250m_%s_%s.csv'%(uni_try, save_date), index=False)
