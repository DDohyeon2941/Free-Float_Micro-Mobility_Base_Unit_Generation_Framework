...
if __name__ == '__main__':
    ...
    for uni_try in range(try_num, 5):
        ...
        vali_num = 1
        temp_pkl = uu.load_gpickle(r'minneapolis_fixed_train_valid_12345_scaler_dataset_%s.pickle'%(save_date))[vali_num]
        ...
        uu.save_gpickle(r'minneapolis_fixed_loss_history_vali_500m_%s_%s_%s.pickle'%(uni_try, vali_num, save_date1), loss_dic)
