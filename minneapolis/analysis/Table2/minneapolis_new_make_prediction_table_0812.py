...
for subset_name in [0,1,2,3,4]:
    ...
    temp_obj = uu.load_gpickle(r'minneapolis_real_pred_y_prop_%s_%s.pickle'%(subset_name, save_date1))
    temp_obj1 = uu.load_gpickle(r'minneapolis_real_pred_y_fixed_%s_%s.pickle'%(subset_name, save_date))
...
index_obj = uu.load_gpickle(r'minneapolis_new_overlapped_index_fixed_prop_0812.pickle')
