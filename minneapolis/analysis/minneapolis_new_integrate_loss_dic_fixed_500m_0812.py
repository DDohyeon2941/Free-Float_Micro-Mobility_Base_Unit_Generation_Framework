...
from  minneapolis_new_main_indi_grids_fixed_train_vali_123_500m_0812 import LSTM1
...
if __name__ == '__main__':
    ...
    for subset_name in range(try_num):
        ...
        loss_dic_list = [
            uu.load_gpickle(r'minneapolis_fixed_loss_history_vali_500m_%s_%s_%s.pickle'%(
