...
import minneapolis_new_data_preproceess_prop_indi_train_test_0810 as pu

import user_utils as uu


def split_train_vali(train_info, vali_days):
    """vali days를 기준, train과 vali set 나눔"""
...
if __name__ == '__main__':
    ...
    #%%
    uu.save_gpickle(r'minneapolis_prop_train_valid_12345_scaler_dataset_0810.pickle', train_vali_dic)
