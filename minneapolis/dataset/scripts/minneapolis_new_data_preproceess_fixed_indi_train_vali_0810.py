...
import minneapolis_new_data_preproceess_fixed_indi_train_test_0810 as pu
...
if __name__ == '__main__':
    ...
    #%%
    uu.save_gpickle(r'minneapolis_fixed_train_valid_12345_scaler_dataset_0810.pickle', train_vali_dic)
