...
import minneapolis_new_data_preproceess_fixed_indi_train_test_250m_0812 as pu
...
if __name__ == '__main__':
    ...
    temp_pkl = pd.read_pickle(r'minneapolis_roughly_filtered_dataset_250m_0615.pkl')
    ...
    #%%
    uu.save_gpickle(r'minneapolis_fixed_train_valid_12345_scaler_dataset_250m_0812.pickle', train_vali_dic)
