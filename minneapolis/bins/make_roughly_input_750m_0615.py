...
#%%
    """
    pd.DataFrame(data=[xx.wkt for xx in grid_poly_list]).to_csv(r'minneapolis_filtered_grid_750m.csv')
    ...
    uu.save_gpickle('minneapolis_grid_elements_750m_0615.pickle', {'grid_list':grid_poly_list,  'alpha':alpha, 'beta':beta})


    new_temp_df.to_pickle(r'minneapolis_roughly_filtered_dataset_750m_0615.pkl')
