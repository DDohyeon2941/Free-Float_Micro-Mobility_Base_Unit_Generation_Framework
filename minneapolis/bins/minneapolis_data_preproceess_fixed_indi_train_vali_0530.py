...
import minneapolis_data_preproceess_fixed_indi_train_test_0530 as pu
...
if __name__ == '__main__':
    ...
    temp_pkl = pd.read_pickle(r'minneapolis_500m_4b_65c_dataset_0530.pkl')
    ...
    #%%
    uu.save_gpickle(r'minneapolis_fixed_train_valid_12345_scaler_dataset_0530.pickle', train_vali_dic)
