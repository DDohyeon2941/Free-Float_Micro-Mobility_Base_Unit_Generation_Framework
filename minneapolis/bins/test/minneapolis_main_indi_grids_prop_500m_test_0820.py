...
from minneapolis_main_indi_grids_fixed_750m_test_0820 import main1
...
if __name__ == '__main__':
    ...
    save_date1 = '0820'
    best_params = {'lr':0.0001, 'hidden': 24, 'seq_length':8, 'batch':8, 'epoch':24}
    ...
    uu.save_gpickle(r'minneapolis_prop_model_loss_test_%s.pickle'%(save_date1), aa2)
    ...
    uu.save_gpickle(r'minneapolis_real_pred_y_prop_%s.pickle'%(save_date1),{'pred_y':np.array(pp_li),'real_y':np.array(yy_li)})
    ...
    o_score_df.to_pickle(r'minneapolis_o_score_df_prop_%s.pkl'%(save_date1))
