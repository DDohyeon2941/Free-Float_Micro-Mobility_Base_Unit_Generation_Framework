...
import minneapolis_data_preproceess_prop_indi_train_test_0809 as pu
...
if __name__ == '__main__':
    ...
    #%%
    uu.save_gpickle(r'minneapolis_prop_train_valid_12345_scaler_dataset_0809.pickle', train_vali_dic)
