...
temp_obj_prop = uu.load_gpickle(r'../test/minneapolis_real_pred_y_prop_0820.pickle')
temp_obj_fixed = uu.load_gpickle(r'../test/minneapolis_real_pred_y_fixed_0820.pickle')
