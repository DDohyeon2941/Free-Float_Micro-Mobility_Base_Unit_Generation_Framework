...
if __name__ == '__main__':
    ...
    save_date1 = '0824'
    best_params = {'lr':0.0007, 'hidden': 8, 'seq_length':8, 'batch':8, 'epoch':24}
    ...
    uu.save_gpickle(r'kansas_fixed_model_loss_test_%s.pickle'%(save_date1), aa2)
    ...
    uu.save_gpickle(r'kansas_real_pred_y_fixed_%s.pickle'%(save_date1),{'pred_y':np.array(pp_li),'real_y':np.array(yy_li)})
    ...
    o_score_df.to_pickle(r'kansas_o_score_df_fixed_%s.pkl'%(save_date1))
