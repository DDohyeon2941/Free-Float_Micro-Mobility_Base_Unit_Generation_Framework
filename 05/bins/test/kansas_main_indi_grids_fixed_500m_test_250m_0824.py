...
if __name__ == '__main__':
    ...
    save_date1 = '0824'
    best_params = {'lr':0.0001, 'hidden': 24, 'seq_length':8, 'batch':8, 'epoch':15}
    ...
    uu.save_gpickle(r'kansas_fixed_model_loss_test_250m_%s.pickle'%(save_date1), aa2)

    #%%

    #aa2= uu.load_gpickle(r'kansas_fixed_model_loss_test_%s.pickle'%(save_date))
    ...
    uu.save_gpickle(r'kansas_real_pred_y_fixed_250m_%s.pickle'%(save_date1),{'pred_y':np.array(pp_li),'real_y':np.array(yy_li)})
    ...
    o_score_df.to_pickle(r'kansas_o_score_df_fixed_250m_%s.pkl'%(save_date1))
