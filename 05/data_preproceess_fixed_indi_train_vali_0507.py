...
import data_preproceess_fixed_indi_train_test_0507 as pu
...
if __name__ == '__main__':
    ...
    temp_pkl = pd.read_pickle(r'kansas_500m_4b_50c_dataset_0507.pkl')
    ...
    #%%
    uu.save_gpickle(r'kansas_fixed_train_valid_12345_scaler_dataset_0507.pickle', train_vali_dic)
