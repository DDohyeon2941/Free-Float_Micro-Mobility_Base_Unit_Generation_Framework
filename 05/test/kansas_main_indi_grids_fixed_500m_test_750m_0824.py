...
from kansas_main_indi_grids_fixed_500m_train_vali_12345_750m_0824 import SharingBikes, LSTM1, train, validate, get_smape
...
if __name__ == '__main__':
    ...
    best_params = {'lr':0.0001, 'hidden': 24, 'seq_length':8, 'batch':8, 'epoch':41}
    ...
    uu.save_gpickle(r'kansas_fixed_model_loss_test_750m_%s.pickle'%(save_date1), aa2)

    #%%

    #aa2= uu.load_gpickle(r'kansas_fixed_model_loss_test_%s.pickle'%(save_date1))
    ...
    uu.save_gpickle(r'kansas_real_pred_y_fixed_750m_%s.pickle'%(save_date1),{'pred_y':np.array(pp_li),'real_y':np.array(yy_li)})
    ...
    o_score_df.to_pickle(r'kansas_o_score_df_fixed_750m_%s.pkl'%(save_date1))
