...
from kansas_new_main_indi_grids_fixed_train_vali_123_250m_0812 import SharingBikes, LSTM1, train, validate
...
temp_pkl1 = uu.load_gpickle(r'kansas_fixed_train_test_scaler_dataset_250m_%s.pickle'%(save_date1))
...
if __name__ == '__main__':
    ...
    try_num = 5
    for uni_try in range(2, try_num):
        ...
        uu.save_gpickle(r'kansas_fixed_model_loss_test_250m_%s_%s.pickle'%(uni_try, save_date), aa2)
        ...
        uu.save_gpickle(r'kansas_real_pred_y_fixed_250m_%s_%s.pickle'%(uni_try, save_date),
        ...
        o_score_df.to_csv(r'kansas_o_score_df_fixed_250m_%s_%s.csv'%(uni_try, save_date), index=False)
