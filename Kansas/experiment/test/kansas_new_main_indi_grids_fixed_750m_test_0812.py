...
from kansas_new_main_indi_grids_fixed_train_vali_123_750m_0812 import SharingBikes, LSTM1, train, validate
...
temp_pkl1 = uu.load_gpickle(r'kansas_fixed_train_test_scaler_dataset_750m_%s.pickle'%(save_date1))
...
if __name__ == '__main__':
    ...
    for uni_try in range(try_num):
        ...
        uu.save_gpickle(r'kansas_fixed_model_loss_test_750m_%s_%s.pickle'%(uni_try, save_date), aa2)
        ...
        uu.save_gpickle(r'kansas_real_pred_y_fixed_750m_%s_%s.pickle'%(uni_try, save_date),
        ...
        o_score_df.to_csv(r'kansas_o_score_df_fixed_750m_%s_%s.csv'%(uni_try, save_date), index=False)
