...
from kansas_new_main_indi_grids_prop_train_vali_123_500m_0812 import SharingBikes, LSTM1, train, validate
...
temp_pkl1 = uu.load_gpickle(r'kansas_prop_train_test_scaler_dataset_%s.pickle'%(save_date1))
...
if __name__ == '__main__':
    ...
    for uni_try in range(try_num, 5):
        ...
        uu.save_gpickle(r'kansas_prop_model_loss_test_%s_%s.pickle'%(uni_try, save_date), aa2)
    
        #%%
        #uni_try = 4
        #aa2= uu.load_gpickle(r'kansas_prop_model_loss_test_%s_%s.pickle'%(uni_try, save_date))
        ...
        uu.save_gpickle(r'kansas_real_pred_y_prop_%s_%s.pickle'%(uni_try, save_date),
        ...
        o_score_df.to_csv(r'kansas_o_score_df_prop_%s_%s.csv'%(uni_try, save_date), index=False)
