...
np.array(list(temp_pkl.loc[(temp_pkl.start_month==8)].reset_index(drop=True).groupby(['start_date','hour','final_new_mask']).count()['year'].unstack(fill_value=0).columns))

#%%

prop_cum_idx = 0
new_obj2 = {}
nan_units = [122, 138, 181]
...
uu.save_gpickle(r'kansas_new_overlapped_index_fixed_prop_0812.pickle',{'fixed_overlapped_index' : fixed_arr,
